    ...
    about: {
      ...
      services: [
        ...
        },
        {
          ...
          description:
            `A verified flight reservation with a real PNR code, the proof of onward travel France visa applicants need alongside insurance. From USD 13 via ${DUMMY_TICKET_365.name}.`,
        },
        {
          icon: <MdOutlineHotel />,
          title: "Hotel Reservations",
          description:
            `Proof of accommodation in France is part of a complete visa file. ${DUMMY_TICKET_365.name} issues these hotel reservations by email, formatted to meet what the consulate expects.`,
        },
      ],
    },
  },
