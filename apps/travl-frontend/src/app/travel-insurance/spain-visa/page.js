...
export const pageData = {
  meta: {
    ...
    productName: "Travel Insurance for Spain Visa",
    description:
    ...
    about: {
      ...
      services: [
        ...
        },
        {
          ...
          description:
            `A verified flight reservation with a real PNR code, the proof of onward travel BLS Spain expects alongside your insurance. From USD 13 via ${DUMMY_TICKET_365.name}.`,
        },
        {
          icon: <MdOutlineHotel />,
          title: "Hotel Reservations",
          description:
            `Proof of accommodation in Spain is part of a complete visa file. ${DUMMY_TICKET_365.name} issues these hotel reservations by email, formatted the way the consulate expects.`,
        },
      ],
    },
  },
  ...
  return (
    <>
      ...
      <Faqs
        ...
        faqs={faqs}
      />
      <RelatedPlans current="/travel-insurance/spain-visa" />
    </>
  );
}
