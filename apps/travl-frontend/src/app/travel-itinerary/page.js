    ...
    <div className="flex flex-col gap-5">
      <div>
        ...
        <h2 className="mt-4 text-xl font-bold text-gray-900">
          Your day-by-day plan, ready to submit
        </h2>
        <p className="mt-1 text-sm text-gray-500">
          <span className="text-2xl font-bold text-gray-900">AED 49</span> ·
          one-time
        </p>
      </div>
      ...
      <p className="text-xs text-gray-400 text-center">
        No account needed. You only pay when you are happy with the preview.
      </p>
    </div>
  );
}
