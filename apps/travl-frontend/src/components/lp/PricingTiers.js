...
import { CURRENCY, PRICING_OPTIONS } from './pricing';
...
export default function PricingTiers({
  title = 'Flight Reservation Pricing',
      ...
      <Container>
        ...
        <div className="hidden overflow-hidden rounded-2xl border border-gray-200 md:block">
          <table className="w-full border-collapse text-left">
            <caption className="sr-only">Flight reservation pricing by validity period</caption>
            <thead>
