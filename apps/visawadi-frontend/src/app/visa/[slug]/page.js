...
export async function generateMetadata({ params }) {
  ...
  const title =
    visa.metaTitle || `${visa.countryName} visa for UAE residents | VisaWadi`;
  const description =
    visa.metaDescription ||
    visa.heroSubheadline ||
    `Apply for your ${visa.countryName} visa with expert assistance from VisaWadi. Document preparation, appointment booking, and end-to-end support.`;
