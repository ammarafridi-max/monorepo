      ...
      columns: [
        {
          heading: 'By Country',
          items: [
            { Icon: Globe, label: 'All Destinations', desc: 'Browse every visa service we offer', href: '/visa' },
  ...
  return (
    <>
      ...
      <QueryClientProvider client={queryClient}>
        <AuthProvider>
          <CurrencyProvider>
            <AppMegaLayout pages={defaultPages} logoAlt={BRAND} footer={visawadiFooter}>
              <main>{children}</main>
            </AppMegaLayout>
            {WHATSAPP_NUMBER && (
              <StickyWhatsApp
