...
export const pageData = {
  ...
  sections: {
    hero: {
      title: 'Terms & Conditions',
      subtitle:
        'Welcome to VisaWadi. By using our website (https://www.visawadi.com) or purchasing any service from us, you agree to comply with the Terms & Conditions below. Please read them carefully before proceeding.',
      ...
      <PrimarySection className="py-12.5">
        <Container>
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            ...
            <li className="pl-2">
              These Terms & Conditions apply to all visitors, users, and customers of VisaWadi.
            </li>
          </ul>
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            ...
            <li className="pl-2">
              Any flight or hotel reservation your application needs must come from the
              provider that issues it. We will review what you supply, but we do not
              issue it and we are not the seller of it.
            </li>
            <li className="pl-2">
              VisaWadi reserves the right to refuse service to users engaging in fraudulent,
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            ...
            <li className="pl-2">
              VisaWadi is not responsible for consequences arising from incorrect or
              incomplete user information.
            </li>
            <li className="pl-2">
              You agree not to submit forged, altered or fraudulent documents. We will
              refuse to file any application we believe contains them.
            </li>
          </ul>
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            <li className="pl-2">
              All content on VisaWadi - including text, graphics, logos, and software - is
              owned by VisaWadi and protected by copyright law.
            </li>
            <li className="pl-2">
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            <li className="pl-2">
              VisaWadi does not guarantee visa approval or any outcome related to visa
              applications.
            </li>
            <li className="pl-2">
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            <li className="pl-2">
              VisaWadi reserves the right to update or modify these Terms & Conditions
