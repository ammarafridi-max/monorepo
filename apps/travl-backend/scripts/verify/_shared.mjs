...
// environment, and composes the domain exactly the way apps/travl-backend does.
//
...
export function readEnv() {
  ...
  return {
    ...
    adminEmail: e.ADMIN_EMAIL ?? 'info@travl.ae',
...
// ---------------------------------------------------------------------------
// system composition — identical wiring to apps/travl-backend/src/routes/index.js
// ---------------------------------------------------------------------------
