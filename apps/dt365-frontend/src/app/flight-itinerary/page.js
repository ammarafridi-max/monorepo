...
export const benefits = [
  ...
  {
    title: 'Great Value',
    text: 'Starting from just USD 13, we provide professionally prepared flight itineraries at an affordable price with fast delivery and clear booking details.',
...
export const pageData = {
  meta: {
    title: 'Flight Itinerary From USD 13 | Instant Delivery With PNR',
    description:
