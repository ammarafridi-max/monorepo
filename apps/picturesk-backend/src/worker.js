// MUST be first: arms Sentry (and its crash handlers) before any pipeline code runs.
...
const pipeline = createPipeline({
  ...
  startingMaxWaitMs: (Number(process.env.TRAINING_STARTING_MAX_MIN) || 45) * 60 * 1000,
