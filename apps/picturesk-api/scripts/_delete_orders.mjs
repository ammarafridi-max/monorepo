import { connectMongo, Order, QUEUE_NAMES, createRedisConnection, createStorage } from '@travel-suite/picturesk-shared';
...
const { ORDER_STATES } = await import('@travel-suite/picturesk-shared');
