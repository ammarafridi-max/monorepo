...
const SCHENGEN = {
  ...
  packages: [
    ...
    },
    {
      ...
      features: [
        ...
        'VFS appointment booking handled by VisaWadi',
  ...
  requirementSections: [
    ...
    },
    {
      ...
      intro: 'Required for all applicants to demonstrate a confirmed travel plan. VisaWadi provides the flight reservation and hotel booking.',
      items: [
  ...
  pricingBreakdown: [
    { item: 'VisaWadi service fee',         amount: 499,  currency: 'AED', paidTo: 'VisaWadi',   note: 'Standard package shown; Express AED 899, Concierge AED 1,799'              },
  ...
  testimonials: [
    {
      ...
      quote:       'I was so worried after reading horror stories about Schengen rejections. VisaWadi reviewed every single document and caught two errors in my bank statements before submission. Approved in 9 days for our Italy trip.',
      rating:      5,
      initials:    'AR',
      imageUrl:    '',
      isFeatured:  true,
    },
    {
      ...
      nationality: 'Emirati',
      visaType:    'Schengen visa',
      quote:       'Second application — first one was rejected by another agent. VisaWadi identified the exact problem with my previous file and fixed it. Got a 2-year multiple-entry Schengen on the reapplication.',
      rating:      5,
      initials:    'MA',
      imageUrl:    '',
      isFeatured:  true,
    ...
    },
    {
      ...
      quote:       'Used the Express service — needed the visa in under a week. VisaWadi delivered. The WhatsApp support was genuinely real-time. Will use again for my next trip.',
      rating:      5,
      initials:    'TM',
      imageUrl:    '',
      isFeatured:  false,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:   'Most Schengen embassies require colour printed copies alongside originals for verification at the VFS counter. Bank statements must be bank-stamped. Your original passport is submitted to VFS and returned with your visa decision. VisaWadi will give you a precise checklist for your specific embassy.',
    },
    {
      question: 'Is a GDS flight reservation accepted by Schengen embassies and VFS?',
      answer:   'Yes. All Schengen embassies and VFS centres accept flight reservations (also called itineraries or dummy tickets) that are verifiable on the airline\'s system. VisaWadi\'s reservations are GDS-based, hold a real booking reference, and can be looked up on the airline\'s website — they are specifically designed and widely accepted for visa applications.',
    },
    {
  ...
  metaTitle:        'Schengen Visa from UAE | VisaWadi Visa Assistance',
...
const UK = {
  ...
  packages: [
    ...
    },
    {
      ...
      features: [
        'Everything in Standard',
        'Priority specialist assignment',
        'VAC appointment booking handled by VisaWadi',
  ...
  pricingBreakdown: [
    { item: 'VisaWadi service fee',            amount: 699,  currency: 'AED', paidTo: 'VisaWadi',           note: 'Standard package; Concierge includes all government fees'         },
  ...
  whyUs: [
    ...
    },
    {
      ...
      description: 'Our pricing is fixed and fully transparent. We tell you upfront exactly what you pay VisaWadi and exactly what you pay the UK government — nothing more.',
      icon:        'Eye',
    },
  ],
  ...
  testimonials: [
    {
      ...
      quote:       'Got refused once before coming to VisaWadi. They read through my refusal notice line by line and restructured my entire application. Approved second time with a 2-year multiple entry visa.',
      rating:      5,
      initials:    'PN',
      imageUrl:    '',
      isFeatured:  true,
    ...
    },
    {
      ...
      nationality: 'Filipino',
      visaType:    'UK Standard Visitor',
      quote:       'VisaWadi handled everything from the VAC appointment to the financial summary document. I just showed up, submitted my biometrics, and got the visa. Simple and stress-free.',
      rating:      5,
      initials:    'RC',
      imageUrl:    '',
      isFeatured:  true,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:   'Yes. All UK visa applicants must attend a UKVI Visa Application Centre in Dubai to submit biometric data (fingerprints and photograph). You cannot submit a UK visa application entirely online. VisaWadi will book your appointment and brief you thoroughly on what to bring and what to expect.',
    },
    {
    ...
    },
    {
      ...
      answer:   'No — each applicant must submit a separate application and pay a separate UK government fee. However, VisaWadi can prepare a coordinated family application ensuring all files are consistent and no application contradicts another.',
    },
  ],

  finalCtaHeadline: 'Ready to apply for your UK visa?',
  finalCtaText:     'Get free consultation',
  metaTitle:        'UK Visa from UAE | VisaWadi Visa Assistance',
...
const USA = {
  ...
  packages: [
    ...
    },
    {
      ...
      features: [
        ...
        'Embassy appointment scheduling managed by VisaWadi',
  ...
  pricingBreakdown: [
    { item: 'VisaWadi service fee',       amount: 799,  currency: 'AED', paidTo: 'VisaWadi',      note: 'Standard package; Concierge includes US MRV fee'                              },
  ...
  testimonials: [
    {
      ...
      quote:       'I had no idea how to handle the DS-160 or what questions they\'d ask at the embassy. VisaWadi prepared everything and ran a mock interview that was almost exactly like the real one. Visa approved first time.',
      rating:      5,
      initials:    'KR',
      imageUrl:    '',
      isFeatured:  true,
    },
    {
      ...
      quote:       'Was refused once before I found VisaWadi. They explained exactly what the consular officer would have flagged in my previous application and rebuilt the whole file. Got my 10-year visa on the reapplication.',
      rating:      5,
      initials:    'SM',
      imageUrl:    '',
      isFeatured:  true,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:   'Yes. In almost all cases, applicants aged 14–79 must attend a personal interview at the US Embassy in Abu Dhabi or the US Consulate General in Dubai. VisaWadi will prepare you thoroughly for this interview so you know exactly what to expect and how to answer.',
    },
    {
    ...
    },
    {
      ...
      answer:   'Yes. There is no mandatory waiting period after a B1/B2 refusal — you can reapply immediately. However, simply reapplying with the same file will almost certainly result in the same outcome. You must present materially different evidence or circumstances. VisaWadi provides a detailed refusal analysis and restructures your entire application before any reapplication.',
    },
    {
  ...
  finalCtaText:     'Get free consultation',
  metaTitle:        'US Visa from UAE | B1/B2 Visa Assistance | VisaWadi',
...
const CANADA = {
  ...
  testimonials: [
    {
      ...
      quote:       'Had been trying to get a Canada visa on my own for two years. VisaWadi reviewed my file, rewrote my cover letter, and restructured how my financials were presented. Approved within 6 weeks.',
      rating:      5,
      initials:    'FZ',
      imageUrl:    '',
      isFeatured:  true,
    },
    {
      ...
      nationality: 'Indian',
      visaType:    'Canada Visitor Visa',
      quote:       'The IRCC portal was overwhelming. VisaWadi handled the entire application, coordinated the biometrics appointment, and kept me updated throughout. Visa came through faster than expected.',
      rating:      5,
      initials:    'RS',
      imageUrl:    '',
      isFeatured:  true,
    },
    {
      ...
      nationality: 'Nigerian',
      visaType:    'Canada Visitor Visa',
      quote:       'Two refusals before VisaWadi. They explained exactly what IRCC officers flag and made my ties to the UAE impossible to question. Got my visa on the third attempt — should have come to them first.',
      rating:      5,
      initials:    'GA',
      imageUrl:    '',
      isFeatured:  true,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:   'Yes — there is no mandatory waiting period after a Canada TRV refusal. However, reapplying with the same application will almost certainly produce the same result. You must submit materially different or stronger evidence. VisaWadi provides a full refusal analysis and rebuilds your application before any reapplication.',
    },
    {
  ...
  finalCtaText:     'Get free consultation',
  metaTitle:        'Canada Visa from UAE | TRV Visa Assistance | VisaWadi',
