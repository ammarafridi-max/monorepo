...
const NAME = process.env.SEED_NAME ?? "Ammar Afridi";
const USERNAME = process.env.SEED_USERNAME ?? "ammar.afridi95";
const EMAIL = process.env.SEED_EMAIL ?? "ammar.afridi95@gmail.com";
const PASSWORD = process.env.SEED_PASSWORD ?? "obaid123";
