...
export const pageData = {
  meta: {
    title: 'Terms & Conditions - The Dummy Ticket AE',
    description:
      'Read the official Terms & Conditions of The Dummy Ticket AE to understand service usage, refunds, legal responsibility, and policies.',
    canonical: 'https://www.thedummyticket.ae/terms-and-conditions',
  },
  breadcrumb: [
    { label: 'Home', path: '/' },
  ...
  sections: {
    hero: {
      ...
      subtitle:
        'Welcome to The Dummy Ticket AE. By using our website (https://www.thedummyticket.ae) or purchasing any service from us, you agree to comply with the Terms & Conditions below. Please read them carefully before proceeding.',
    },
  },
};
      ...
      <PrimarySection className="py-12.5">
        <Container>
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            <li className="pl-2">
              The Dummy Ticket AE provides travel-related services including dummy flight tickets,
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            ...
            <li className="pl-2">
              The Dummy Ticket AE reserves the right to refuse service to users engaging in fraudulent,
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            ...
            <li className="pl-2">
              The Dummy Ticket AE is not responsible for consequences arising from incorrect or
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            <li className="pl-2">
              All content on The Dummy Ticket AE - including text, graphics, logos, and software - is
              owned by The Dummy Ticket AE and protected by copyright law.
            </li>
            <li className="pl-2">
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            <li className="pl-2">
              The Dummy Ticket AE does not guarantee visa approval or any outcome related to visa
              applications.
            </li>
            <li className="pl-2">
          ...
          <ul className="text-md font-extralight flex flex-col gap-3 list-decimal pl-5">
            <li className="pl-2">
              The Dummy Ticket AE reserves the right to update or modify these Terms & Conditions
