...
export const pageData = {
  meta: {
    ...
    canonical: 'https://www.thedummyticket.ae/emirates-dummy-ticket',
  ...
  sections: {
    ...
    benefits: {
      ...
      subtitle:
        'To get an Emirates dummy ticket, The Dummy Ticket AE is a perfect choice. We provide real, embassy-ready flight reservations that look professional, verify correctly, and support your visa file without financial risk.',
      benefits,
    },
    faqs: {
