    ...
    <PrimarySection className="bg-gray-50 py-28 md:py-30 font-outfit">
      <Container>
        <div className="text-center space-y-6">
          <h1 className="text-[72px] md:text-[96px] font-bold text-primary-600 leading-none">
            500
          </h1>
          ...
          <div className="pt-6 flex items-center justify-center gap-4 flex-wrap">
            <button
              onClick={reset}
              className="inline-block bg-primary-600 text-white text-[16px] font-medium px-6 py-3 rounded-full shadow-md hover:bg-primary-700 transition-all duration-300"
            >
              Try Again
            </button>
            <PrimaryLink
              to="/"
              className="inline-block border border-primary-600 text-primary-600 text-[16px] font-medium px-6 py-3 rounded-full hover:bg-primary-50 transition-all duration-300"
            >
              Go Back Home
            </PrimaryLink>
          </div>
