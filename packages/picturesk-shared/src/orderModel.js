...
const orderSchema = new Schema(
  {
    ...
    // The purchased pricing tier (id from @travel-suite/picturesk-shared pricing.js), plus a
    ...
    // The customer's choices (catalog ids from @travel-suite/picturesk-shared catalog.js),
    ...
    // Subject demographics (catalog ids from @travel-suite/picturesk-shared catalog.js),
