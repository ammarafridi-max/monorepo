...
function normalizeUsername(value) {
  ...
  if (!USERNAME_REGEX.test(username)) {
    throw new AppError(
      'Username must be 8-50 characters and use lowercase letters, numbers, dots, underscores, or hyphens',
      400,
    );
  }
  return username;
...
export const updateAdminUserSchema = (body = {}) => {
  ...
  if (Object.prototype.hasOwnProperty.call(body, 'name')) payload.name = normalizeName(body.name);
