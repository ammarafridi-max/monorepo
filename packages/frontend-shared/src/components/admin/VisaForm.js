...
import { Lock, Unlock, Trash2, Star, Globe, EyeOff, Copy } from 'lucide-react';
import {
  slugify, Card, Field, TextInput, TextareaInput,
        ...
        <div className="space-y-5">
          ...
          <Card title="Visa Details" collapsible>
            <div className="space-y-4">
              ...
              <Field
                label="Excerpt"
                hint="One or two lines shown on the /visa listing card. Aim for under 140 characters."
                error={errors.excerpt?.message}
              >
                <TextareaInput
                  {...register('excerpt', {
                    maxLength: { value: 200, message: 'Excerpt must be 200 characters or fewer' },
                  })}
                  rows={2}
                  placeholder="e.g. Visit 29 European countries on one application, with your documents checked before you submit."
                />
              </Field>
            </div>
          </Card>
