        ...
        <div className="max-w-4xl lg:mx-auto lg:text-center">
          ...
          <div className="flex flex-wrap gap-3 mb-8 lg:justify-center">
            <button
              type="button"
              onClick={onCtaClick}
              className="inline-flex min-h-11 items-center gap-2 font-outfit font-semibold text-[14px] py-2.5 px-5 sm:text-[16px] sm:py-3.5 sm:px-7 rounded-full bg-accent-500 hover:bg-accent-600 text-gray-900 shadow-sm hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
            >
              {ctaText}
            </button>
            <a
              href="#packages"
              className={`inline-flex min-h-11 items-center gap-2 text-[14px] py-2.5 px-5 sm:text-[15px] sm:py-3.5 sm:px-6 font-outfit font-medium rounded-full border transition-colors duration-200 ${
                hasImage
