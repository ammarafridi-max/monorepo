...
const defaultServices = [
  {
    ...
    title: 'Dummy Tickets',
    description:
      'Our dummy tickets are genuine flight reservations with a verifiable PNR. Issued in a format accepted by visa officers at VFS, BLS, and embassies, so you can show proof of travel intent without buying a real ticket.',
  },
  {
    icon: <MdOutlineHotel />,
    title: 'Hotel Reservations',
    description:
      'We provide hotel reservations on request, formatted to meet embassy requirements. If your visa application needs proof of accommodation, we can have it ready for you quickly.',
  },
  {
    icon: <MdOutlineHealthAndSafety />,
    title: 'Travel Insurance',
    description:
      'We offer genuine travel insurance policies covering medical emergencies, trip cancellations, and more. Our Schengen-compliant plans meet the required medical coverage threshold and are issued and delivered instantly.',
  },
];

export default function About({
  title = 'About Us',
  text = 'We are a licensed travel agency based in Dubai, UAE. We help residents across the UAE and GCC get the travel documents they need for visa applications, quickly and without hassle. Our documentation is accepted by VFS, BLS, and embassies worldwide.',
  services = defaultServices,
}) {
  return (
    <PrimarySection className="py-section" id="about">
