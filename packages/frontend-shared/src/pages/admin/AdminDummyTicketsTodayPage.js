...
import {
  ...
  Loader2, ArrowUpRight, CalendarCheck,
} from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-5">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-gray-900">Today's Deliveries</h2>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-gray-600">No deliveries scheduled for today</p>
              <p className="text-xs text-gray-400 mt-1">Check back later or view all tickets.</p>
            </div>
          </div>
        ) : (
          <>
